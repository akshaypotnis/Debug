#include <stdio.h>
  ...
  void deletion(struct treeNode **node, struct treeNode **parent, int data,struct treeNode **root) {
        ...
        if ((*node)->data == data) {
                ...
                /* deleting node with one child */
                        ...
                        *node = (*parent)->right;
                        ...
                        free(tmpNode);
                       // printf("%d",(*node)->data);
                        //(*node) = (*parent)->left;//error statement1
                ...
                deletion(&(*node)->left, node, data,*root);
        } else if (data > (*node)->data) {
                /* traversing towards right subtree */
                deletion(&(*node)->right, node, data,*root);
        }
  }
        ...
        while (1) {
                ...
                switch (ch) {
                        ...
                        case 2:
                                ...
                                scanf("%d", &data);
                                //if(root->data == data){
                                //	printf("You are trying to delete the root .It cannot be deleted!!");
                                //}else{
                                	deletion(&root, NULL, data,&root);
                              //  }
                                break;
                        case 3:
